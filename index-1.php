...
$password = "1234"; // এখানে পাসওয়ার্ড ১২৩৪ সেট করা আছে
...
if (isset($_POST['login'])){
	if($_POST['password'] == $password){
		...
		header("location: index.php");
			...
			$_SESSION['alert'] = '<div class="alert alert-danger alert-white rounded"><div class="icon"><i class="fa fa-times-circle"></i></div><strong>Login Failed!</strong></div><br>';
			}
	}
?>
<!DOCTYPE html>
